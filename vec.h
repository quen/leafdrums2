...
typedef int (__cdecl* QSORTPROC)(const void* pe1,const void* pe2);
...
//				*(m_ppObj[i])=;
	...
	void Sort(int (__cdecl *cf)(const O** e1,const O** e2))
	{
		qsort(m_ppObj,m_iSize,sizeof(O*),(QSORTPROC)cf);
	}
};
